...
class ShuffleNetV2(nn.Module):
    def __init__(
        ...
        **kwargs
        ...
        self.mutisampledropout1d = MultiSampleDropout(self.fc, dim=1, p=0.5)
    ...
    def _forward_impl(self, x: Tensor):
        ...
        x3 = self.stage3(x2)  # (b,232,14,14) x 1/16 #up_round
        ...
        x_cls2 = self.mutisampledropout1d(x)
        return x_cls1, x_cls2, x1, x2, x3, x4

    def forward(self, x: Tensor):
        cls1, cls2, x1, x2, x3, x4 = self._forward_impl(x)  #
        x0_1_out, x2_1_out, x0_2_out, x2_2_out = self.mask_branch(x1, x2, x3, x4)
        return [[cls1, cls2], [x0_1_out, x0_2_out, x2_1_out, x2_2_out]]
